...
- **[v2.6.0 部署手册](./runbooks/v2.6.0-deploy.md)：生产部署以这份为准**（迁移 021–027、部署顺序、监控、回滚）；它是 [v2.5.0 手册](./runbooks/v2.5.0-deploy.md) 的增量，两份都要读。
...
- [版本历史 / Changelog](../CHANGELOG.md)：主版本入口与里程碑索引。当前版本 `v2.6.0`。
