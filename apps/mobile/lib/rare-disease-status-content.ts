 ...
 *  [注册]  《药品注册管理办法》第六十七条（优先审评审批的适用范围）
 *          与第六十八条（该程序给予的时限）. 这两条容易并成一条引用：
 *          被引号括起来的那句罕见病用药范围出自第六十七条，130/70 日
 *          的时限出自第六十八条。患者拿错条号去窗口，正是这一页要
 *          避免的事。
...
export const RARE_DISEASE_SECTIONS: RareDiseaseSection[] = [
  ...
  },
  {
    ...
    points: [
      '目录最实在的一项作用是药品通道：《药品注册管理办法》第六十七条把「防治重大传染病和罕见病等疾病的创新药和改良型新药」列入优先审评审批的适用范围，第六十八条给出时限：上市许可申请审评时限一百三十日；临床急需的境外已上市境内未上市的罕见病药品，审评时限七十日。',
    ...
    source:
      '《药品注册管理办法》第六十七条、第六十八条；losmapimod 三期 REACH 结果与项目暂停见 Fulcrum Therapeutics 2024-09-12 公告',
  },
];
