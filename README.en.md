...
- [Version History / Changelog](./CHANGELOG.md) — includes the `v2.6.0` entry.
- [v2.6.0 Deploy Runbook](./docs/runbooks/v2.6.0-deploy.md) — required reading before deploying `v2.6.0`; a delta on the v2.5.0 runbook, not a replacement.
